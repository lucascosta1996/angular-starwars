...
describe('SwapiService', () => {
  ...
  beforeEach(() => {
    ...
    postService = TestBed.get(DataService);
    httpMock = TestBed.get(HttpTestingController);
  });

  it(`should fetch posts as an Observable`, async(inject([HttpTestingController, DataService],
    (httpClient: HttpTestingController, dataService: DataService) => {
      ...
      dataService.getCharacters( 1 )
        .subscribe((characters: any) => {
          expect(characters.length).toBe(10);
        });

      let req = httpMock.expectOne('https://swapi.co/api/people/?page=1');
